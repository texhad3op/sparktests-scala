...
sbt clean package && C:\spark-2.2.1-bin-hadoop2.7\bin\spark-submit.cmd --class test.Classification --master local[*] C:\tests\sparktests-scala\target\scala-2.11\sparktests-scala_2.11-0.1.jar
